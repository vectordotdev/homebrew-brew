class Vector < Formula
  ...
  on_macos do
    ...
    on_arm do
      url "https://packages.timber.io/vector/0.53.0/vector-0.53.0-arm64-apple-darwin.tar.gz" # arm64 url
      sha256 "a42c59263abbbcae012a2c0f73c3e916dc220305b2a223725f2324ae18efcd80" # arm64 sha256
    end
  end
