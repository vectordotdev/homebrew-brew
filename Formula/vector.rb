class Vector < Formula
  ...
  on_macos do
    ...
    on_arm do
      url "https://packages.timber.io/vector/0.54.0/vector-0.54.0-arm64-apple-darwin.tar.gz" # arm64 url
      sha256 "ef6e5062e6887a9499f211f4231f2c60565081c5f80f9a7f585f73b1811b6d3b" # arm64 sha256
    end
  end
