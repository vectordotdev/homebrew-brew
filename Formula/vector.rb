class Vector < Formula
  ...
  on_macos do
    ...
    on_arm do
      url "https://packages.timber.io/vector/0.51.1/vector-0.51.1-arm64-apple-darwin.tar.gz" # arm64 url
      sha256 "b506d8171c1907f5e224a56f58a81c7e3f72d287afa9a8dc30a21005e65c2807" # arm64 sha256
    end
  end
