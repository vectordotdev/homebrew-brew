class Vector < Formula
  ...
  on_macos do
    ...
    on_arm do
      url "https://packages.timber.io/vector/0.52.0/vector-0.52.0-arm64-apple-darwin.tar.gz" # arm64 url
      sha256 "29f59cab87b419c54b1b04f7ecb71f3a8974dd4c8dd1b66bd88d2c783049d57e" # arm64 sha256
    end
  end
